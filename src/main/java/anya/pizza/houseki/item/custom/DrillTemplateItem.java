...
public class DrillTemplateItem extends SmithingTemplateItem {
    ...
    private static final Identifier EMPTY_SLOT_DRILL_TEXTURE = Identifier.of(Houseki.MOD_ID, "item/drill_slot");
    private static final Identifier EMPTY_SLOT_DRILLBIT_TEXTURE = Identifier.of(Houseki.MOD_ID, "item/drillbit_slot");
    private static final Identifier EMPTY_SLOT_CSTEEL_BLOCK_TEXTURE = Identifier.of(Houseki.MOD_ID, "item/csteel_block_slot");
